...
const HandleSendRequest = async(status,_id)=>{
  ...
  <div className="card-body">
    ...
    <button className="btn btn-primary text-white" onClick={()=>HandleSendRequest("ignored",_id)} >Ignore</button>
      <button className="btn btn-primary bg-green-800 text-white" onClick={()=>HandleSendRequest("interested",_id)}>Interested</button>
    </div>
  </div>
</div>
    </div>
